...
with open('C:/Users/Karamjit/Documents/Election.csv') as csvfile:
    ...
    print(f"CSV Header: {csvheader}", file = k)
...
print("Election Results", file = k)
print("-------------------", file = k)
print("Total votes: " + str(totalvotes), file = k)
print("-------------------", file = k)
print("Charles Casper Stockham: " + str(round1) + "% (" + str(charles_num_of_votes) + ")", file = k)
print("Diana DeGette: " + str(round2) + "% (" + str(diana_num_of_votes) + ")", file = k)
print("Raymond Anthony Doane: " + str(round3) + "% (" + str(raymon_num_of_votes) + ")", file = k)
print("-------------------", file = k)
print("Winner: " + winner, file = k)
k.close()