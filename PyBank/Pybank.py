...
print("Average Change: $" + str(rounded))
...
print("Greatest Increase In Profits: " + str(date[max_index+1]) + " ($" + str(max_value) + ")")
print("Greatest Decrease in Profits: " + str(date[min_index+1]) + " ($" + str(min_value) + ")")
